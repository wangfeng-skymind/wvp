...
import jessibucaPlayer from './jessibucax.vue'
...
export default {
    ...
    props: {},
    components: {
        player,H265web,jessibucaPlayer
    },
    computed: {
  ...
  setup:{
    ...
    methods: {
        ...
        openDialog: function (tab, deviceId, channelId, param) {
            console.log(">>>>>>>>Mmm====>>>>" + JSON.stringify(param))
        ...
        playFromStreamInfo: function (realHasAudio, streamInfo) {
          ...
          this.$refs.videoPlayer.play(streamInfo.flv)
        },
        close: function () {
            console.log('关闭视频');
            if (!!this.$refs.videoPlayer){
        ...
        playRecord: function (row) {
          console.log("..q1..>>>>>>>" + row);
            ...
            let that = this;
          console.log(that.streamId+ ".d2...>>>>>>>" + row);

          if (that.streamId != "") {
              console.log(that.streamId+ "...111.>>>>>>>" + row);
              ...
              console.log(that.streamId+ "..222.>>>>>>>" + row);
